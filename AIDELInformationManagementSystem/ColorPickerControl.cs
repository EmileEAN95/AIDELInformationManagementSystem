...
namespace ColorPicker
{
	...
	{
        public EventHandler SelectedColorChanged;
		...
		void OnColorWheelSelectionChanged(object sender, EventArgs e)
		{
			...
			if (selcol != null && selcol != m_selectedColor)
			{
				...
				m_colorSample.Refresh();
				if (m_lockColorTable == false && selcol != m_colorTable.SelectedItem)
        ...
        {
			m_colorTable.SelectFirstCustomColor();
		}
	}
