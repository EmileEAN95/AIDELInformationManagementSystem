...
namespace ColorPicker
{
    class EyedropColorPicker : Control
    {
        ...
        public EyedropColorPicker()
        {
            ...
            m_icon = new Bitmap(Resources.eyedropper);
        ...
        RectangleF ImageRect
        {
            get
            {
                return ColorUtil.Rect(ClientRectangle);
            }
        }
        ...
        void GetSnapshot()
        {
            ...
            using (Graphics dc = Graphics.FromImage(m_snapshot))
            {
                ...
                PointF center = ColorUtil.Center(new RectangleF(0, 0, m_snapshot.Size.Width, m_snapshot.Size.Height));
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (m_snapshot != null)
            {
                ...
                if (m_iscapturing)
                {
                    ...
                    Rectangle centerrect = new Rectangle(ColorUtil.Point(center), new Size(0, 0));
            ...
            ColorUtil.DrawFrame(e.Graphics, rr, 6, Color.CadetBlue);
        }
