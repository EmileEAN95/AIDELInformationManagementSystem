...
namespace ColorPicker
{
    class ColorWheel : Control
    {
        ...
        public HSLColor SelectedHSLColor
        {
            ...
            set
            {
                if (m_selectedColor == value)
                    return;
                Invalidate(ColorUtil.Rect(ColorSelectorRectangle));
                m_selectedColor = value;
                if (SelectedColorChanged != null)
                    SelectedColorChanged(this, null);
                Refresh();//Invalidate(ColorUtil.Rect(ColorSelectorRectangle));
            }
        }
        public ColorWheel()
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            ColorUtil.DrawFrame(e.Graphics, wheelrect, 6, m_frameColor);

            wheelrect = ColorWheelRectangle;
            PointF center = ColorUtil.Center(wheelrect);
            ...
            e.Graphics.FillPie(m_brush, ColorUtil.Rect(wheelrect), 0, 360);
            ...
            if (Focused)
            {
                ...
                r.Inflate(-2, -2);
                ControlPaint.DrawFocusRectangle(e.Graphics, ColorUtil.Rect(r));
            }
        }
        ...
        RectangleF ColorSelectorRectangle
        {
            get
            {
                ...
                PointF center = ColorUtil.Center(ColorWheelRectangle);
        ...
        {
            Rectangle r = ColorUtil.Rect(ColorSelectorRectangle);
            PointF center = ColorUtil.Center(r);
