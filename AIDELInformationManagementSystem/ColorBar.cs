    ...
    class ColorSlider : LabelRotate
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Focused)
            {
                ...
                lr.Inflate(-2, -2);
                ControlPaint.DrawFocusRectangle(e.Graphics, ColorUtil.Rect(lr));
            }
        }
        ...
        protected void DrawColorBar(Graphics dc)
        {
            ...
            if (m_numberOfColors == eNumberOfColors.Use2Colors)
                ColorUtil.Draw2ColorBar(dc, lr, Orientation, m_color1, m_color2);
            else
                ColorUtil.Draw3ColorBar(dc, lr, Orientation, m_color1, m_color2, m_color3);
    ...
    class HSLColorSlider : ColorSlider
    {
        ...
        public HSLColor SelectedHSLColor
        {
            ...
            set
            {
                ...
                Refresh();//Invalidate(ColorUtil.Rect(BarRectangle));
            }
        }
