...
namespace ColorPicker
{
    ...
    {
        static ColorPickerControl m_colorPicker;
    ...
    public class DropdownContainer<T> : Form
    {
        ...
        public DropdownContainer(DropdownContainerControl<T> owner)
        {
            ...
            WinColorUtil.SetWindowPos(Handle, IntPtr.Zero, 0, 0, 0, 0, WinColorUtil.SWP_NOACTIVATE);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            r.Width--;
            r.Height--;
            ColorUtil.DrawFrame(e.Graphics, r, 6, Color.CadetBlue);
